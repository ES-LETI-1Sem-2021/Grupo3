...
public class GithubTests {
	...
	void testGetTags() throws IOException {	
		...
		assertTrue(temp.contains("v0.1.0"));
		assertTrue(temp.contains("Sun Nov 21 23:36:16 WET 2021"));
		assertTrue(temp.contains("v0.2.0"));
		assertTrue(temp.contains("Tue Dec 07 23:42:08 WET 2021"));
		assertTrue(temp.contains("v0.3.0"));
		assertTrue(temp.contains("Wed Dec 08 00:06:50 WET 2021"));
	}
