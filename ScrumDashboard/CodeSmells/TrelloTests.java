...
public class TrelloTests {
	...
	public void testNoArtifact() {
		...
		for(Tabela t : tables){
			if(t.getTitle().equals("Total")){
				assertEquals(75,(int) t.getObject(3,1));
				break;
				}
		}
	}
	...
	public void testArtifact() {
		...
		for(Tabela t : tables){
			if(t.getTitle().equals("Total")){
				assertEquals(11,(int) t.getObject(3,1));
				break;
				}
		}
	}
	...
	public void testRecursosHumanos() {
		...
		for(Tabela t : tables){
			if(t.getTitle().equals("Total")){
				assertEquals(1080.0,(double) t.getObject(3,1));
				break;
				}
		}
	}
	...
	public void testSprintTime() {
		...
		for(Tabela t : tables){
			if(t.getTitle().equals("Total")){
				assertEquals(54.0,(double)t.getObject(3,1));
				break;
				}
		}
	}
